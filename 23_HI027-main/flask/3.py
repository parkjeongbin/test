...
def on_button_click_3():  # 이동 완료 버튼
    label.config(text="이동이 완료되었습니다.")
    subprocess.Popen(["pkill", "-f", "move1.py"])
...
button_3 = tk.Button(root, text="이동 완료", width=30, height=3, command=on_button_click_3)
